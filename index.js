...
bot.command("start", async ctx => {
    await ctx.reply("The MEGATRON bot is currently experiencing a little downtime.")
    // try {
...
bot.command("buy", async ctx => {
    await ctx.reply("The MEGATRON bot is currently experiencing a little downtime. Sorry for the Inconveniences.")
    // try {
    //     await ctx.replyWithHTML(
